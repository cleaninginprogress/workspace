...
path = rospkg.RosPack().get_path("my_ros_opencv")
...
class PeopleDetection(object):
    ...
    def __init__(self):
        ...
        rospy.init_node("people_object_detect", anonymous=True)
        rospy.Subscriber("/usb_cam/image_raw", Image, self.update_frame_callback)
        self.pub = rospy.Publisher('/people_object_detection', String, queue_size=10)
